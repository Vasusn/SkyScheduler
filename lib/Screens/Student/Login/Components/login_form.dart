...
class _StudentLoginFormState extends State<StudentLoginForm> {
   final emailController = TextEditingController();
    ...
    void signUserIn() async {
      ...
      try {
        await FirebaseAuth.instance.signInWithEmailAndPassword(email: emailController.text, password: passwordController.text).then((value) => Navigator.push(context, MaterialPageRoute(builder: (context)=> StudentHomePage())));
