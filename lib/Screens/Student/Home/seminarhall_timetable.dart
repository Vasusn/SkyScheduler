...
class SeminarhallTimeTableScreen extends StatefulWidget {
  const SeminarhallTimeTableScreen({Key? key}) : super(key: key);

  @override
  State<SeminarhallTimeTableScreen> createState() => _FacultyTimeTableScreenState();
}

class _FacultyTimeTableScreenState extends State<SeminarhallTimeTableScreen> {
