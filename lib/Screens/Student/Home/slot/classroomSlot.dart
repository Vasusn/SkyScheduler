...
class ClassRoomSlot extends StatefulWidget {
  
   ClassRoomSlot({super.key});

  @override
  State<ClassRoomSlot> createState() => _ClassRoomSlotState();
}

class _ClassRoomSlotState extends State<ClassRoomSlot> {
