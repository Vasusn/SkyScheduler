...
import 'package:skyscheduler/Screens/Student/Home/slot/classroomSlot.dart';
import 'package:skyscheduler/constants.dart';

class ClassroomTimetable extends StatefulWidget {
  const ClassroomTimetable({super.key});

  @override
  State<ClassroomTimetable> createState() => _ClassroomTimetableState();
}

class _ClassroomTimetableState extends State<ClassroomTimetable> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> ClassRoomSlot()));
                  },
                  child: Text(
                    "Book slot".toUpperCase(),
                  ),
                ),
              ),
            ],
